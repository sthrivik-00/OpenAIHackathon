...
$literals = array(
	...
	array(
		"en" => 'Vodafone account number:',
		"es" => 'Nº de cuenta Vodafone:',
		"ar" => 'Vodafone account number:',
		"fr" => 'Numéro de compte Vodafone:',
		"de" => 'Vodafone-Kontonummer:',
		"it" => 'Numero di conto Vodafone:',
		"ja" => '??????????:',
		"pt" => 'Número da conta Vodafone:'
	),
...
SELECT a.bill_no, statement_date, from_date, to_date, total, tax, total_invoice, payment_date,
	...
	(select external_id from accounts where account_no = a.account_no) acc_external_id
...
$pdf->SetY(40);
$pdf->SetX(15); $pdf->Cell($field_left_width,4, $literals[0][LANG]); $pdf->Cell($field_left_width,4, $rec_invoice_data[0][0]); $pdf->Ln(4);
$pdf->SetX(15); $pdf->Cell($field_left_width,4, $literals[1][LANG]); $pdf->Cell($field_left_width,4, $rec_invoice_data[0][18]); $pdf->Ln(4);
